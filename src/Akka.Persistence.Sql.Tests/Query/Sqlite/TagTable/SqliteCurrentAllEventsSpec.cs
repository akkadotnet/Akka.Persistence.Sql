...
namespace Akka.Persistence.Sql.Tests.Query.Sqlite.TagTable
{
    ...
    public class SqliteCurrentAllEventsSpec : BaseCurrentAllEventsSpec<SqliteContainer>
    {
        public SqliteCurrentAllEventsSpec(ITestOutputHelper output, SqliteContainer fixture)
            : base(TagMode.TagTable, output, nameof(SqliteCurrentAllEventsSpec), fixture) { }
    }
}
