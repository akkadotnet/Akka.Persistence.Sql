...
{
    public abstract class BaseEventsByPersistenceIdSpec : EventsByPersistenceIdSpec, IAsyncLifetime
    {
        private readonly ITestConfig _config;
        private readonly TestFixture _fixture;

        protected BaseEventsByPersistenceIdSpec(ITestConfig config, ITestOutputHelper output, TestFixture fixture)
            : base(Config(config, fixture), nameof(EventsByPersistenceIdSpec), output)
        {
            _config = config;
            _fixture = fixture;
        }
