...
{
    public abstract class BaseCurrentEventsByTagSpec : CurrentEventsByTagSpec, IAsyncLifetime
    {
        private readonly ITestConfig _config;
        private readonly TestFixture _fixture;

        protected BaseCurrentEventsByTagSpec(ITestConfig config, ITestOutputHelper output, TestFixture fixture)
