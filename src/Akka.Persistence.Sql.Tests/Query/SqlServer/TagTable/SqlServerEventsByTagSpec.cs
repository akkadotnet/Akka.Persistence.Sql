...
namespace Akka.Persistence.Sql.Tests.Query.SqlServer.TagTable
{
    ...
    public class SqlServerEventsByTagSpec : BaseEventsByTagSpec<SqlServerContainer>
    {
        public SqlServerEventsByTagSpec(ITestOutputHelper output, SqlServerContainer fixture)
            : base(TagMode.TagTable, output, nameof(SqlServerEventsByTagSpec), fixture) { }
    }
}
