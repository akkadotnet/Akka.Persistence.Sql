// -----------------------------------------------------------------------
//  <copyright file="MySqlCurrentPersistenceIdsSpec.cs" company="Akka.NET Project">
...
namespace Akka.Persistence.Sql.Tests.Query.MySql.Csv
{
    ...
    public class MySqlCurrentPersistenceIdsSpec : BaseCurrentPersistenceIdsSpec<MySqlContainer>
    {
