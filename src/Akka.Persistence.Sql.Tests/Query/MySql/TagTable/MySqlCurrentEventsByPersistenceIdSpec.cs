// -----------------------------------------------------------------------
//  <copyright file="MySqlCurrentEventsByPersistenceIdSpec.cs" company="Akka.NET Project">
...
namespace Akka.Persistence.Sql.Tests.Query.MySql.TagTable
{
    ...
    public class MySqlCurrentEventsByPersistenceIdSpec : BaseCurrentEventsByPersistenceIdSpec<MySqlContainer>
    {
