...
namespace Akka.Persistence.Sql.Tests.Query.MsSqlite.Csv
{
    ...
    public class SqliteCurrentPersistenceIdsSpec : BaseCurrentPersistenceIdsSpec
    {
        public SqliteCurrentPersistenceIdsSpec(ITestOutputHelper output, TestFixture fixture)
