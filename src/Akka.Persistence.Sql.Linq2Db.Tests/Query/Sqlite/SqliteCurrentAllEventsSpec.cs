...
namespace Akka.Persistence.Sql.Linq2Db.Tests.Query.Sqlite
{
    ...
    public class SqliteCurrentAllEventsSpec : CurrentAllEventsSpec, IAsyncLifetime
    {
...
akka.test.single-expect-default = 10s")
        ...
        public SqliteCurrentAllEventsSpec(ITestOutputHelper output, TestFixture fixture) : base(Config(fixture), nameof(SqliteCurrentAllEventsSpec), output)
        {
            _fixture = fixture;
        }
