...
namespace Akka.Persistence.Linq2Db.Benchmark.DockerComparisonTests.SqlCommon
{
    ...
    {
        public DockerSqlServerJournalPerfSpec(ITestOutputHelper output, SqlServerFixture fixture) 
            : base(InitConfig(fixture),"sqlserverperfspec", output, 40, eventsCount: TestConstants.DockerNumMessages)
        {
        }
